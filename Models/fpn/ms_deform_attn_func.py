...
def ms_deform_attn_core_pytorch(value, value_spatial_shapes, sampling_locations, attention_weights):
    ...
    for lid_, (H_, W_) in enumerate(value_spatial_shapes):
        ...
        sampling_grid_l_, _ = torch.sort(sampling_grid_l_, dim=2, descending=True)
        sampling_grid_l_ = sampling_grid_l_[:, :, :4, :]
        # N_*M_, D_, Lq_, P_
    ...
    attention_weights = attention_weights.transpose(1, 2).reshape(N_*M_, 1, Lq_, L_*4) # eg. [bs * 8, 1, 1045, 4 * 4], 4个特征层 * 4个采样点
